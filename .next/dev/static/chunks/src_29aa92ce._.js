...
"[project]/src/lib/axios-public.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function KioskPage() {
    ...
    const handleSelectDept = async (dept)=>{
        ...
        setError(null);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$kiosk$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].takeQueue(dept.id);
...
//# sourceMappingURL=src_29aa92ce._.js.map