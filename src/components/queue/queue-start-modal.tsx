...
import { Play, Loader2, Search, UserPlus, Check } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
interface QueueStartModalProps {
  open: boolean;
...
export function QueueStartModal({
  open,
  onOpenChange,
  queue,
  onSuccess,
  onRegisterPatient,
}: QueueStartModalProps) {
  ...
  const handleStart = async () => {
    ...
    try {
      ...
      // Start the service
      await queueService.startQueue(queue.id);
      ...
      toast.error("Gagal memulai layanan", {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[550px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Mulai melayani antrian dan assign data pasien
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="py-4 space-y-4">
          ...
          {/* Info */}
          <div className="p-3 rounded-lg bg-purple-50 dark:bg-purple-950 text-sm text-purple-700 dark:text-purple-300">
            <p>
              Anda dapat memulai layanan tanpa data pasien. Data pasien dapat
              ditambahkan kemudian jika diperlukan.
            </p>
          </div>
        </div>
